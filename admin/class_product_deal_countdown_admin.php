...
class Product_Deal_Countdown_Admin {
	...
	public function admin_enqueue_scripts() {
		...
		if ( $page === 'product-deal-countdown-checkout' ) {
			// global $wp_scripts;
			...
			// 	}
			// }
			// wp_enqueue_style( 'product-deal-countdown-semantic-button', SALES_COUNTDOWN_TIMER_CSS . 'button.min.css' );
			// wp_enqueue_style( 'product-deal-countdown-semantic-form', SALES_COUNTDOWN_TIMER_CSS . 'form.min.css' );
			// wp_enqueue_style( 'product-deal-countdown-semantic-menu', SALES_COUNTDOWN_TIMER_CSS . 'menu.min.css' );
			// wp_enqueue_style( 'product-deal-countdown-semantic-message', SALES_COUNTDOWN_TIMER_CSS . 'message.min.css' );
			// wp_enqueue_style( 'product-deal-countdown-semantic-label', SALES_COUNTDOWN_TIMER_CSS . 'label.min.css' );
			// wp_enqueue_style( 'product-deal-countdown-semantic-input', SALES_COUNTDOWN_TIMER_CSS . 'input.min.css' );
			// wp_enqueue_style( 'product-deal-countdown-semantic-transition', SALES_COUNTDOWN_TIMER_CSS . 'transition.min.css' );
			// wp_enqueue_style( 'product-deal-countdown-semantic-segment', SALES_COUNTDOWN_TIMER_CSS . 'segment.min.css' );
			// wp_enqueue_style( 'product-deal-countdown-semantic-popup', SALES_COUNTDOWN_TIMER_CSS . 'popup.min.css' );
			// wp_enqueue_style( 'product-deal-countdown-semantic-tab', SALES_COUNTDOWN_TIMER_CSS . 'tab.css' );
			// wp_enqueue_style( 'product-deal-countdown-semantic-header', SALES_COUNTDOWN_TIMER_CSS . 'header.min.css' );

			// wp_enqueue_style( 'product-deal-countdown-admin-css', SALES_COUNTDOWN_TIMER_CSS . 'admin-checkout.css' );

			// wp_enqueue_script( 'jquery-ui-sortable' );
			// wp_enqueue_script( 'product-deal-countdown-semantic-address', SALES_COUNTDOWN_TIMER_JS . 'address.min.js', array( 'jquery' ) );
			// wp_enqueue_script( 'product-deal-countdown-semantic-form', SALES_COUNTDOWN_TIMER_JS . 'form.js', array( 'jquery' ) );
			// wp_enqueue_script( 'product-deal-countdown-semantic-tab', SALES_COUNTDOWN_TIMER_JS . 'tab.js', array( 'jquery' ) );
			// wp_enqueue_script( 'product-deal-countdown-semantic-transition', SALES_COUNTDOWN_TIMER_JS . 'transition.min.js', array( 'jquery' ) );
			// wp_enqueue_script( 'product-deal-countdown-admin-js', SALES_COUNTDOWN_TIMER_JS . 'admin-checkout.js', array( 'jquery' ), SALES_COUNTDOWN_TIMER_VERSION );
		} elseif ( $page == 'product-deal-countdown' ) {
			global $wp_scripts;
			...
			/*Stylesheet*/
			wp_enqueue_style( 'product-deal-countdown-semantic-button', PDC_URL . 'css/button.min.css' );
			...
			wp_enqueue_style( 'product-deal-countdown-semantic-icon', PDC_URL . 'css/icon.min.css' );
			wp_enqueue_style( 'product-deal-countdown-semantic-menu', PDC_URL . 'css/menu.min.css' );
			wp_enqueue_style( 'product-deal-countdown-semantic-segment', PDC_URL . 'css/segment.min.css' );
			wp_enqueue_style( 'product-deal-countdown-semantic-label', PDC_URL . 'css/label.min.css' );
			...
			wp_enqueue_style( 'product-deal-countdown-semantic-header', PDC_URL . 'css/header.min.css' );
			wp_enqueue_style( 'product-deal-countdown-semantic-popup', PDC_URL . 'css/popup.min.css' );
