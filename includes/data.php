...
class Product_Deal_countdown_default_Data {
	...
	public function get_params( $name = "" ) {
		if ( ! $name ) {
			...
			return apply_filters( 'product_deal_countdown_settings-' . $name, $this->params[ $name ] );
		} else {
			return false;
		}
	}
	...
	public function get_default( $name = "" ) {
		if ( ! $name ) {
			...
			return apply_filters( 'product_deal_countdown_settings_default-' . $name, $this->default[ $name ] );
		} else {
			return false;
		}
	}
